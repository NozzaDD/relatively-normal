...
A styling newsletter, and eventually a wardrobe tool.

## Structure

| Folder | Contents |
| --- | --- |
| `voice/` | Writing samples and the do/don't style guide |
| `frameworks/` | Colour system, coverage matrix, material rubric |
