...
Generated from `content/backlog.yaml` against `data/metrics.yaml` on 2026-09-20. 
...
- **What of this is actually wearable in a European autumn** — `series-fashion-week-european-lens` · idea · window 2026-09-17 to 2026-10-06
...
- **Tell me one thing in your closet you've had five years and still love. I'll go first.** — `note-five-years-still-love` · idea · evergreen
- **Everyone should get themselves an Italian boyfriend (a Genoa lunch, one sentence)** — `note-italian-boyfriend` · idea · evergreen
- **I'm done pretending minimalism means beige everything** — `note-minimalism-not-beige` · idea · evergreen
- **A purchase that didn't work and what it taught me** — `note-purchase-that-didnt-work` · idea · evergreen
- **What's the one thing in your wardrobe you'd rebuy immediately?** — `note-rebuy-question` · idea · evergreen
- **Two newsletters I actually read, tagged** — `note-recommend-two-newsletters` · idea · evergreen
- **Tracking a Vestiaire jumpsuit like it's a person I have a crush on** — `note-secondhand-anticipation` · idea · evergreen
- **Big US newsletters link to things Europeans can't practically buy** — `note-shipping-and-duties` · idea · evergreen
- **The one piece that survived the move to Zürich when other things didn't** — `note-survived-the-move` · idea · evergreen
- **Why I'm suspicious of anyone who says they found their style** — `note-suspicious-of-found-their-style` · idea · evergreen
- **I style outfits I will never buy. It's how I figured out what I actually wear.** — `note-thesis` · idea · evergreen
- **Nobody talks about how exhausting it is to unlearn that treating yourself means buying something** — `note-treating-yourself` · idea · evergreen
- **What I'd style for a Zürich autumn Saturday** — `note-zurich-saturday` · idea · evergreen

## Waiting

| Entry | Type | Waiting on |
|---|---|---|
| Five free consultations — subscribe and comment to enter | campaign | opens 2026-10-06 (16 days) |
| Round two — priority for paid subscribers | campaign | beta round 1 complete has not happened |
| The only thing worth buying this week is something filling a gap you already know | campaign | opens 2026-11-16 (57 days) |
| Dressing for the things December actually asks of you | campaign | opens 2026-11-30 (71 days) |
| New Year, New Gaps — four weeks, one step each | series | opens 2026-12-28 (99 days) |
...
## The rules that travel with this list
